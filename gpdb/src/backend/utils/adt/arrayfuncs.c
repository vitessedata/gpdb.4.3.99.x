...
/*
 * array_contains_nulls -- detect whether an array has null elements.
 * This function gives accurate answer, which is different from ARR_HASNULL, which 
 * tells if the array *may* have nulls.
 */
bool
