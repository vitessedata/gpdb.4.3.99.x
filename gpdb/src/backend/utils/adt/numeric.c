 ...
 */
extern Numeric numeric_stddev_internal(ArrayType *transarray,
 ...
 * EXX: Expose.
 */
extern void exx_init_var_from_num(Numeric value, NumericVar *dest);
void exx_init_var_from_num(Numeric value, NumericVar *dest) {
    init_var_from_num(value, dest);
}
extern void exx_init_var_from_str(const char* value, NumericVar *dest);
void exx_init_var_from_str(const char* value, NumericVar *dest) {
    init_var_from_str(value, dest);
}
extern void exx_add_var(NumericVar *var1, NumericVar *var2, NumericVar *result);
void exx_add_var(NumericVar *var1, NumericVar *var2, NumericVar *result) {
    add_var(var1, var2, result);
}
extern Numeric exx_make_result(NumericVar *var);
Numeric exx_make_result(NumericVar *var) {
    return make_result(var);
}
extern NumericVar* exx_p_const_nan(void);
NumericVar* exx_p_const_nan() { return &const_nan; }
extern NumericVar* exx_p_const_one(void);
NumericVar* exx_p_const_one() { return &const_one; }
extern NumericVar* exx_p_const_zero(void);
NumericVar* exx_p_const_zero() { return &const_zero; }

extern void exx_init_var(NumericVar *var);
void exx_init_var(NumericVar *var) { init_var(var); }

extern void exx_mul_var(NumericVar *var1, NumericVar *var2, NumericVar *result, int rscale);
void exx_mul_var(NumericVar *var1, NumericVar *var2, NumericVar *result, int rscale) {
    mul_var(var1, var2, result, rscale);
}
extern void exx_alloc_var(NumericVar *var, int ndigits);
void exx_alloc_var(NumericVar *var, int ndigits) {
    alloc_var(var, ndigits);
}
extern void exx_free_var(NumericVar *var); 
void exx_free_var(NumericVar *var) {
    free_var(var);
}
extern void exx_int8_to_numericvar(int64 val, NumericVar *var);
void exx_int8_to_numericvar(int64 val, NumericVar *var) {
    int8_to_numericvar(val, var);
}
extern int exx_cmp_var(NumericVar *var1, NumericVar *var2);
int exx_cmp_var(NumericVar *var1, NumericVar *var2) {
    return cmp_var(var1, var2);
}

extern void exx_sub_var(NumericVar *var1, NumericVar *var2, NumericVar *result);
void exx_sub_var(NumericVar *var1, NumericVar *var2, NumericVar *result) {
    return sub_var(var1, var2, result);
}

extern void exx_div_var(NumericVar *var1, NumericVar *var2, NumericVar *result, int rscale, bool round);
void exx_div_var(NumericVar *var1, NumericVar *var2, NumericVar *result, int rscale, bool round) {
    div_var(var1, var2, result, rscale, round);
}

extern int exx_select_div_scale(NumericVar *var1, NumericVar *var2);
int exx_select_div_scale(NumericVar *var1, NumericVar *var2) {
    return select_div_scale(var1, var2);
}

extern void exx_sqrt_var(NumericVar *arg, NumericVar *result, int rscale);
void exx_sqrt_var(NumericVar *arg, NumericVar *result, int rscale) {
    sqrt_var(arg, result, rscale);
}
