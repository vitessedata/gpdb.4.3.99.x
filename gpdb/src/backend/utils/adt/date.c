...
/*
 * EXX: expose static functions.
 */
extern Timestamp exx_date2timestamp(DateADT dateVal);
Timestamp exx_date2timestamp(DateADT dateVal) { return date2timestamp(dateVal); }
extern TimestampTz exx_date2timestamptz(DateADT dateVal);
TimestampTz exx_date2timestamptz(DateADT dateVal) { return date2timestamptz(dateVal); }
