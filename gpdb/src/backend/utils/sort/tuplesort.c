 ...
 * EXX_IN_PG 
 */
int exx_cmp_idxtuple(const void *_a, const void *_b, void *_state)
{
	const ExxSortIdxTuple *a = (const ExxSortIdxTuple *) _a;
	const ExxSortIdxTuple *b = (const ExxSortIdxTuple *) _b;
	ExxSortIdxCmpCtxt *state = (ExxSortIdxCmpCtxt *) _state;
