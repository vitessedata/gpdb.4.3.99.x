...
/* 
 * EXX: This guc will put the smaller side of the hashjoin as built, bigger as probe.
 * It is almost always right decision, therefore, enable by default.
 */
bool        gp_enable_hashjoin_size_heuristic = true; 
...
static struct config_int ConfigureNamesInt[] =
{
...

    {
        {"writable_external_table_bufsize", PGC_USERSET, EXTERNAL_TABLES,
            ...
            gettext_noop("Valid value is between 32K and 128K: [32, 131072]."),
...

	{
		...
		&max_stack_depth,
		1000, 100, MAX_KILOBYTES, assign_max_stack_depth, NULL
	},
	...
	{
		{"optimizer_mdcache_size", PGC_USERSET, QUERY_TUNING_METHOD,
