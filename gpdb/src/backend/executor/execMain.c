...
ExecutorStart(QueryDesc *queryDesc, int eflags)
{
	...
	START_MEMORY_ACCOUNT(plannedStmt->memoryAccount);
	{
        ...
        if (estate->es_instrument) {
            estate->exx_jit = (ExxJitInstrumentation *) palloc0(sizeof(ExxJitInstrumentation));
        } else {
            estate->exx_jit = 0;
        }
...
EvalPlanQualStart(evalPlanQual *epq, EState *estate, evalPlanQual *priorepq)
{
    ...
    if (epqstate->es_instrument) {
        epqstate->exx_jit = (ExxJitInstrumentation *) palloc0(sizeof(ExxJitInstrumentation));
    } else {
        epqstate->exx_jit = 0;
    }
...
EvalPlanQualStop(evalPlanQual *epq)
{
    ...
    epqstate->es_result_partitions = NULL;
