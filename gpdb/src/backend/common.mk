...
CFLAGS := $(CFLAGS) -I$(top_builddir)/../toolchain/installed/include -msse4.2
CXXFLAGS=$(filter-out -std=gnu99 -Wmissing-prototypes -fexcess-precision=standard -Wdeclaration-after-statement, $(CFLAGS)) 
