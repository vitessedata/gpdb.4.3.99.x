...
typedef struct TuplesortPos_bkt TuplesortPos_bkt;
typedef struct Tuplesortstate_bkt Tuplesortstate_bkt;

extern Tuplesortstate_bkt *tuplesort_begin_index_bkt(Relation idxrel, 
		bool enforceUnique, int workMem, bool randomAccess);
extern void tuplesort_putindextuple_bkt(Tuplesortstate_bkt *state, IndexTuple itup);
extern void tuplesort_performsort_bkt(Tuplesortstate_bkt *state);
extern IndexTuple tuplesort_getindextuple_bkt(Tuplesortstate_bkt *state, 
		bool forward, bool *should_free);
extern void tuplesort_end_bkt(Tuplesortstate_bkt *state);


typedef struct ExxSortIdxTuple
{
	IndexTuple tuple;
#if 0
	Datum	datum1;
...
typedef struct ExxSortIdxCmpCtxt
{
	int nKeys;
	Relation indexRel;
...
int exx_cmp_idxtuple(const void *a, const void *b, void *ctxt);
