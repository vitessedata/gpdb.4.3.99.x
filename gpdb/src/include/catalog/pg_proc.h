...
/* bitand("bit", "bit") => "bit" */ 
DATA(insert OID = 1673 ( bitand  PGNSP PGUID 12 f f t f i 2 1560 f "1560 1560" _null_ _null_ _null_ bit_and - _null_ n ));
DESCR("bitwise and");

/* bitor("bit", "bit") => "bit" */ 
DATA(insert OID = 1674 ( bitor  PGNSP PGUID 12 f f t f i 2 1560 f "1560 1560" _null_ _null_ _null_ bit_or - _null_ n ));
DESCR("bitwise or");
