...
extern Sample *make_sample(Plan *lefttree, Node *sampleRate, Node *sampleCount, SampleMethod sm); 
extern Transducer *make_transducer(Plan *lefttree, const char *trname); 
